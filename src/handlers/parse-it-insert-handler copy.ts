...
const apolloClient = generateApolloClient({
  path: "3006-deepfoundation-dev-vr5pi8ica3v.ws-us106.gitpod.io/gql",
  ssl: true,
});
...
let deep = new DeepClient({ deep: guestDeep, ...admin });
deep = new DeepClient({
  deep: deep,
  ...(await deep.login({
    linkId: await deep.id("@deep-foundation/object-to-links-async-converter"),
  })),
});
await deep.reserve(27278)
